#Função que exibe os sabore, tamanhos e valores das pizzas
def exibir_cardapio():
...
#Declarar função que receberá por padrão que a borda não é recheada. Além diso, irá receber também o sabor e o tamanho da pizza.
def fazer_pedido(sabor, tamanho="M", borda_recheada=False):
    borda = "Com borda recheada" if borda_recheada else "sem borda"
    #variável = valor se verdadeiro if condição logica else valor se falso.
