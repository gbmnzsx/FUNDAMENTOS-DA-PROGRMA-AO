...
#De 101 kWh até 200 kWh -> R$ 0,60 por kWh - 40 + 60 -R$ 100
#Acima de 200 kWh -> R$ 0,90 por kWh
#Exibir ao final: o consumo informado, a faixa de tarifa aplicada e o valor total a ser pago.
#Caso o consumo informado seja negativo,exibir uma mensagem de valor invalido.



#Declaraçao das variaveis globais - snake_case
valor_ate_100kwh = 0.40 
valor_ate_200kwa = 0.60
valor_acima_200kwa = 0.90

print(f" ----- Seja Bem Vindo ao programa de cálculo de energia -----")
while True:
    input_kwa = input(f"Digite a quantidade de kwa consumidos(ou 'sair' para encerrar)")
    if input_kwa.lower() == 'sair':
        print(f"Encerrando o programa. Obrigado por usar!\n")
        break
